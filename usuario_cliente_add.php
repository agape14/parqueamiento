	...
	$pass=md5($password);
		...
		///finzalizo encriptacion
			...
			mysqli_query($con,"INSERT INTO usuario(usuario,password,imagen,tipo,nombre,apellido,telefono,correo)
				VALUES('$usuario','$pass','$img','reserva','$nombre','$apellido','$telefono','$correo')")or die(mysqli_error($con));
		...
		$pass=$salt.$pass;
			...
			mysqli_query($con,"INSERT INTO usuario(usuario,password,imagen,tipo,nombre,apellido,telefono,correo,estado)
				VALUES('$usuario','$pass','','reserva','$nombre','$apellido','$telefono','$correo','activo')")or die(mysqli_error($con));
