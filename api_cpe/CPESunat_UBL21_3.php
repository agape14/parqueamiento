...
<Invoice xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:ccts="urn:un:unece:uncefact:documentation:2" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2" xmlns:qdt="urn:oasis:names:specification:ubl:schema:xsd:QualifiedDatatypes-2" xmlns:udt="urn:un:unece:uncefact:data:specification:UnqualifiedDataTypesSchemaModule:2" xmlns="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2">
	...
	<cac:AccountingCustomerParty>
        ...
        If ($cabecera["TOTAL_DETRACCIONES"] > 0) {
            $xmlCPE = $xmlCPE .
                    '<cac:PaymentTerms>
                    <cbc:ID schemeAgencyName="PE:SUNAT" schemeName="Codigo de detraccion" schemeURI="urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo54">' . $cabecera["CODIGO_DETRACCION"] . '</cbc:ID>
                    <cbc:PaymentPercent>' . $cabecera["POR_DETRACCION"] . '</cbc:PaymentPercent>
                    <cbc:Amount currencyID="' . $cabecera["COD_MONEDA"] . '">' . $cabecera["TOTAL_DETRACCIONES"] . '</cbc:Amount>
                    </cac:PaymentTerms>';
        }
        ...
        if ($cabecera["TOTAL_PERCEPCIONES"] > 0) {
                $xmlCPE = $xmlCPE .  "<cac:AllowanceCharge>
                              ...
                              <cbc:AllowanceChargeReasonCode listAgencyName='PE:SUNAT' listName='Cargo/descuento' listURI='urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo53'>54</cbc:AllowanceChargeReasonCode>
        ...
        if ($cabecera["FLG_REGU_ANTICIPO"] == 1) {
            $xmlCPE = $xmlCPE .
                ...
                <cbc:PaidAmount currencyID="' . $cabecera["COD_MONEDA"] . '">' . $cabecera["MONTO_REGU_ANTICIPO"] . '</cbc:PaidAmount>
		</cac:PrepaidPayment>';
        }
	...
	<cac:LegalMonetaryTotal>
        ...
        //era total descuento ya no va ese campo en la nueva version de sunat
		//<cbc:AllowanceTotalAmount currencyID="' . $cabecera["COD_MONEDA"] . '">' . $cabecera["TOTAL_DESCUENTO"] . '</cbc:AllowanceTotalAmount>
//        if ($cabecera["TOTAL_PERCEPCIONES"] > 0) {
//            $xmlCPE = $xmlCPE .
//                    '<cbc:ChargeTotalAmount currencyID="' . $cabecera["COD_MONEDA"] . '">' . $cabecera["TOTAL_PERCEPCIONES"] . '</cbc:ChargeTotalAmount>
//                    <cbc:PayableAmount currencyID="' . $cabecera["COD_MONEDA"] . '">' . $cabecera["TOTAL_COBRAR"] . '</cbc:PayableAmount>';
//        } else {
//            $xmlCPE = $xmlCPE .
...
//        }
        if ($cabecera["FLG_REGU_ANTICIPO"] == 1) {
            $xmlCPE = $xmlCPE .
                    '<cbc:PrepaidAmount currencyID="' . $cabecera["COD_MONEDA"] . '">' . $cabecera["MONTO_REGU_ANTICIPO"] . '</cbc:PrepaidAmount>';
                    //<cbc:PayableAmount currencyID="' . $cabecera["COD_MONEDA"] . '">0.00</cbc:PayableAmount>';
        }
...
function cpeRetenciones($ruta, $cabecera, $detalle) {
    try {
        $doc = new DOMDocument();
        $doc->formatOutput = FALSE;
        $doc->preserveWhiteSpace = TRUE;
        $doc->encoding = 'ISO-8859-1';
        $xmlCPE = "<?xml version='1.0' encoding='ISO-8859-1' standalone='no'?><Retention xmlns='urn:sunat:names:specification:ubl:peru:schema:xsd:Retention-1' xmlns:cac='urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2' xmlns:cbc='urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2' xmlns:ccts='urn:un:unece:uncefact:documentation:2' xmlns:ds='http://www.w3.org/2000/09/xmldsig#' xmlns:ext='urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2' xmlns:qdt='urn:oasis:names:specification:ubl:schema:xsd:QualifiedDatatypes-2' xmlns:sac='urn:sunat:names:specification:ubl:peru:schema:xsd:SunatAggregateComponents-1' xmlns:udt='urn:un:unece:uncefact:data:specification:UnqualifiedDataTypesSchemaModule:2' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'>
                <ext:UBLExtensions>
                <ext:UBLExtension>
                <ext:ExtensionContent>
                </ext:ExtensionContent>
                ...
                <cac:PostalAddress>
                <cbc:ID>" . $cabecera["COD_UBIGEO_EMPRESA"] . "</cbc:ID>
                ...
                <cbc:District><![CDATA[" . $cabecera["DISTRITO_EMPRESA"] . "]]></cbc:District>
                <cac:Country>
                <cbc:IdentificationCode>" . $cabecera["COD_PAIS_EMPRESA"] . "</cbc:IdentificationCode>
                </cac:Country>
                </cac:PostalAddress>
                <cac:PartyLegalEntity>
                <cbc:RegistrationName><![CDATA[" . $cabecera["RAZON_SOCIAL_EMPRESA"] . "]]></cbc:RegistrationName>
                ...
                <cac:ReceiverParty>
                <cac:PartyIdentification>
                <cbc:ID schemeID='" . $cabecera["TIPO_DOCUMENTO_PROVEEDOR"] . "'>" . $cabecera["NRO_DOCUMENTO_PROVEEDOR"] . "</cbc:ID>
                </cac:PartyIdentification>
                <cac:PartyName>
                <cbc:Name><![CDATA[" . $cabecera["NOMBRE_COMERCIAL_PROVEEDOR"] . "]]></cbc:Name>
                </cac:PartyName>
                <cac:PostalAddress>
                <cbc:ID>" . $cabecera["COD_UBIGEO_PROVEEDOR"] . "</cbc:ID>
                <cbc:StreetName><![CDATA[" . $cabecera["CIUDAD_PROVEEDOR"] . "]]></cbc:StreetName>
                <cbc:CitySubdivisionName/>
                <cbc:CityName><![CDATA[" . $cabecera["DEPARTAMENTO_PROVEEDOR"] . "]]></cbc:CityName>
                <cbc:CountrySubentity><![CDATA[" . $cabecera["PROVINCIA_PROVEEDOR"] . "]]></cbc:CountrySubentity>
                <cbc:District><![CDATA[" . $cabecera["DISTRITO_PROVEEDOR"] . "]]></cbc:District>
                <cac:Country>
                <cbc:IdentificationCode>" . $cabecera["PAIS_PROVEEDOR"] . "</cbc:IdentificationCode>
                </cac:Country>
                </cac:PostalAddress>
                <cac:PartyLegalEntity>
                <cbc:RegistrationName><![CDATA[" . $cabecera["RAZON_SOCIAL_PROVEEDOR"] . "]]></cbc:RegistrationName>
                </cac:PartyLegalEntity>
                </cac:ReceiverParty>
                <sac:SUNATRetentionSystemCode>" . $cabecera["TIPO_RETENCION"] . "</sac:SUNATRetentionSystemCode>
                <sac:SUNATRetentionPercent>" . $cabecera["PORCENTAJE_RETENCION"] . "</sac:SUNATRetentionPercent>
                <cbc:Note>" . $cabecera["NOTA"] . "</cbc:Note>
                <cbc:TotalInvoiceAmount currencyID='" . $cabecera["MONEDA"] . "'>" . $cabecera["TOTAL_RETENCION"] . "</cbc:TotalInvoiceAmount>
                <sac:SUNATTotalPaid currencyID='" . $cabecera["MONEDA"] . "'>" . $cabecera["NETO_RETENCION"] . "</sac:SUNATTotalPaid>";

        for ($i = 0; $i < count($detalle); $i++) {
            $xmlCPE = $xmlCPE . "<sac:SUNATRetentionDocumentReference>
                <cbc:ID schemeID='" . $detalle[$i]["COD_TIPO_DOCUMENTO"] . "'>" . $detalle[$i]["NRO_DOCUMENTO"] . "</cbc:ID>
                <cbc:IssueDate>" . $detalle[$i]["FECHA_DOCUMENTO"] . "</cbc:IssueDate>
                <cbc:TotalInvoiceAmount currencyID='" . $detalle[$i]["COD_MONEDA"] . "'>" . $detalle[$i]["MONTO_TOTAL"] . "</cbc:TotalInvoiceAmount>
                <cac:Payment>
                <cbc:ID>" . $detalle[$i]["NRO_DOC_PAGO"] . "</cbc:ID>
                <cbc:PaidAmount currencyID='" . $detalle[$i]["COD_MONEDA"] . "'>" . $detalle[$i]["MONTO_TOTAL"] . "</cbc:PaidAmount>
                <cbc:PaidDate>" . $detalle[$i]["FECHA_PAGO"] . "</cbc:PaidDate>
                </cac:Payment>
                <sac:SUNATRetentionInformation>
                <sac:SUNATRetentionAmount currencyID='" . $detalle[$i]["MONEDA_RETENCION"] . "'>" . $detalle[$i]["MONTO_RETENCION"] . "</sac:SUNATRetentionAmount>
                <sac:SUNATRetentionDate>" . $detalle[$i]["FECHA_RETENCION"] . "</sac:SUNATRetentionDate>
                <sac:SUNATNetTotalPaid currencyID='" . $detalle[$i]["MONEDA_PAGO_NETO"] . "'>" . $detalle[$i]["MONTO_PAGO_NETO"] . "</sac:SUNATNetTotalPaid>
                </sac:SUNATRetentionInformation>
...
function cpeBajaSunatRetPer($ruta, $cabecera, $detalle) {
    try {
        $doc = new DOMDocument();
        $doc->formatOutput = FALSE;
        $doc->preserveWhiteSpace = TRUE;
