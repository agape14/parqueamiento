...
$cabecera = array(
    ...
    'txtPESO_BRUTO'                  => (isset($cab['txtPESO_BRUTO'])) ? $cab['txtPESO_BRUTO'] : "",
...
//====================DATOS SUNAT=====================//
    ...
    "txtCodigoTicket"                => (isset($cab['txtCodigoTicket'])) ? $cab['txtCodigoTicket'] : "",
    "txtFechaIngreso"                => (isset($cab['txtFechaIngreso'])) ? $cab['txtFechaIngreso'] : "",
    "txtFechaSalida"                 => (isset($cab['txtFechaSalida'])) ? $cab['txtFechaSalida'] : "",
    "txtHoraIngreso"                 => (isset($cab['txtHoraIngreso'])) ? $cab['txtHoraIngreso'] : "",
    "txtHoraSalida"                  => (isset($cab['txtHoraSalida'])) ? $cab['txtHoraSalida'] : "",
    "txtPlacaTicket"                 => (isset($cab['txtPlacaTicket'])) ? $cab['txtPlacaTicket'] : "",
);
...
//$resultado['cod_comprobante'] = $mensaje_cpe['cod_comprobante'];
