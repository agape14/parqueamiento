...
//require_once '../pages/facturacion/guardarComprobante.php';
function cpe(
//===============DATOS DE LA EMPRESA===============
    ...
    $cabecera = array(
        ...
        'CodigoTicket'                => (isset($cab['txtCodigoTicket'])) ? $cab['txtCodigoTicket'] : "",
        'FechaIngreso'                => (isset($cab['txtFechaIngreso'])) ? $cab['txtFechaIngreso'] : "",
        'FechaSalida'                 => (isset($cab['txtFechaSalida'])) ? $cab['txtFechaSalida'] : "",
        'HoraIngreso'                 => (isset($cab['txtHoraIngreso'])) ? $cab['txtHoraIngreso'] : "",
        'HoraSalida'                  => (isset($cab['txtHoraSalida'])) ? $cab['txtHoraSalida'] : "",
        'PlacaTicket'                 => (isset($cab['txtPlacaTicket'])) ? $cab['txtPlacaTicket'] : "",
    );
    ...
    /*$cod_estado_comp = $response['hash_cdr']['cod_sunat'];
    $des_estado_comp = str_replace("'", "", $response['hash_cdr']['msj_sunat']);
    $hash_comp       = $response['hash_cdr']['hash_cdr'];
    $response['cod_comprobante'] = guadarComprobanteBD($cabecera, $detalle, $cod_estado_comp, $des_estado_comp, $hash_comp);*/
    return $response;
}
