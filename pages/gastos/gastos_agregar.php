 ...
 <!--end of modal-->
        ...
        <form class="form-horizontal" method="post" action="gastos_add.php" enctype='multipart/form-data'>
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                        <label for="date" >Valor S/.</label>

                      </div><!-- /.form group -->
                    </div>
                       <div class="col-md-4 btn-print">
                      <div class="form-group">
                                 <input type="text" class="form-control pull-right"  id="cantidad"  name="cantidad" onkeypress='return event.charCode >= 48 && event.charCode <= 57 ' required >
