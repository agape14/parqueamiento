...
$nro_cocheras=0;
   // $branch=$_SESSION['branch'];
    $query1=mysqli_query($con,"select * from espacios where id_espacios='$id_espacios' ")or die(mysqli_error());

    while($row1=mysqli_fetch_array($query1)){

$nro_cocheras=$row1['numero'];
$medida=$row1['medida'];
$tipo_espacio=$row1['tipo_espacio'];
...
?>
        ...
        <form class="form-horizontal" method="post" action="cocheras_actualizar.php" enctype='multipart/form-data'>
            ...
            <input type="text" class="form-control" id="nro_cochera" name="nro_cochera" value="<?php echo $nro_cocheras;?>"  required>
                      </div>
                    </div>
                           <div class="col-md-4 btn-print">
                 ...
                 <input type="text" class="form-control" id="medida" name="medida" value="<?php echo $medida;?>"  required >
       ...
       <div class="row">
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                        <label for="date" >Tipo espacio</label>
                 ...
                 <input type="text" class="form-control" id="tipo_espacio" name="tipo_espacio" value="<?php echo $tipo_espacio;?>"  required >
