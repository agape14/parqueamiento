...
if ($caja_cont > 0) {
 ...
 <button type="button" class="btn btn-danger btn-lg btn-print" data-toggle="modal" data-target="#miModalcajacerrar">
  ...
  <a class="btn btn-danger btn-print"    disabled="true" style="height:25%; width:50%; font-size: 25px " role="button">MONTO CAJA= <label style='color:black;  font-size: 25px '>=  <?php echo "$simbolo_moneda $acumulado"; ?></label></a>
...
$query = mysqli_query($con, "select * from caja") or die(mysqli_error());
$i     = 0;
...
// ]]></script>
    ...
    <footer>
          <div class="pull-right">
             <a href="#">ventas - Sistema de Parqueo</a>
          </div>
