...
<?php if ($tipo == "administrador") {?>
          ...
          <li><a href="../facturacion/listado_tickets_anulados.php">Tickets Anulados</a></li>
          <li><a href="../facturacion/listado_tickets_revertidos.php">Tickets Revertidos</a></li>
<?php }?>
                              <li><a href="../facturacion/listado_facturacion.php">Boletas</a></li>
<?php if ($tipo == "administrador") {?>
                              <li><a href="../facturacion/listado_facturacion_anulados.php">Boletas Anulados</a></li>
<?php }?>
