...
while ($rowc = mysqli_fetch_array($queryc)) {
 ...
 <div class="row">
                    <div class="col-md-3 btn-print">
                      ...
                      </div><!-- /.form group autocomplete="off" -->
                    </div>
                       <div class="col-md-4 btn-print">
                      <div class="form-group">

            <input type="text" class="form-control" id="placa" name="placa" style="text-transform:uppercase;" value=""  onkeyup="javascript:this.value=this.value.toUpperCase();" oninput="this.value = this.value.replace(/[^a-zA-Z0-9]/,'')" maxlength="6"  required>
                      </div>
                    </div>
                           <div class="col-md-4 btn-print">
