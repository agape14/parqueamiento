...
?>
        ...
        <form class="form-horizontal" method="post" action="salir_add.php" enctype='multipart/form-data'>
                    ...
                    <div class="row">
                      <h2 class="box-title"> Vehiculo con placa: <?php echo strtoupper($placa) . '<br>'; ?> Cochera Nro: <?php echo $numero; ?></h2>
                    <div class="col-md-3 btn-print">
                      ...
                      <div class="form-group">
              <select class="form-control select2" name="dia_noche" required autofocus>
