                   ...
                   <div class="row">
                    ...
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                       ...
                       <div class="col-md-4 btn-print">
                      <div class="form-group">
                                 <input type="text" class="form-control pull-right"  minlength="11"  maxlength="11" id="ruc"  name="ruc"   onkeypress='return event.charCode >= 48 && event.charCode <= 57'/>
                    ...
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                       ...
                       <div class="col-md-4 btn-print">
                      <div class="form-group">
                        <input type="text" class="form-control pull-right"  minlength="8"  maxlength="8" id="dni" name="dni" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/>
