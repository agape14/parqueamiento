...
$nro_cocheras=0;
   // $branch=$_SESSION['branch'];
    $query1=mysqli_query($con,"select * from tarifa where id_tarifa='$id_tarifa' ")or die(mysqli_error());

    while($row1=mysqli_fetch_array($query1)){

$valor_hora=$row1['valor_hora'];
$valor_noche=$row1['valor_noche'];
$valor_mes=$row1['valor_mes'];
$tipo_vehiculo=$row1['tipo_vehiculo'];
...
?>
        ...
        <form class="form-horizontal" method="post" action="tarifas_actualizar.php" enctype='multipart/form-data'>
   <div class="row">
            ...
            <input type="text" class="form-control" id="tipo_vehiculo" name="tipo_vehiculo" value="<?php echo $tipo_vehiculo;?>"  required>
                      </div>
                    </div>
                           <div class="col-md-4 btn-print">
            ...
            <input type="text" class="form-control" id="valor_hora" name="valor_hora" value="<?php echo $valor_hora;?>"  required>
                      </div>
                    </div>
                           <div class="col-md-4 btn-print">
                 ...
                 <input type="text" class="form-control" id="valor_noche" name="valor_noche" value="<?php echo $valor_noche;?>"  required >
                    <input type="hidden" class="form-control" id="id_tarifa" name="id_tarifa" value="<?php echo $id_tarifa;?>"  required >
                      </div>
                    </div>
                           <div class="col-md-4 btn-print">
          ...
          <div class="row">
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                        <label for="date" >Valor por mes</label>
            ...
            <input type="text" class="form-control" id="valor_mes" name="valor_mes" value="<?php echo $valor_mes;?>"  required>
                      </div>
                    </div>
                           <div class="col-md-4 btn-print">
