...
facturacion_estado_descripcion,facturacion_hash,total_descripcion,hora_comprobante,fec_registro)
...
'$descestadocomp','$hashcomprobante','$total_descripcion','$hora_comprobante','$fec_hora_actual') ";
...
for ($i = 0; $i < count($detallecab); $i++) {
    ...
    $subtotaldet = $detallecab[$i]["txtIMPORTE_DET"];
