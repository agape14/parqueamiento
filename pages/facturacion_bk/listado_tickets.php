...
<div class="right_col" role="main">
    ...
    $query    = mysqli_query($con, "select e.id_entrada,e.codigo,e.fecha,e.dia_noche,
										...
										WHERE e.fecha_salida IS NOT NULL AND f.numero IS NULL AND e.estado=1 AND  e.fecha >='$fecha' AND e.fecha<='$fechafin' ") or die(mysqli_error());
    $i = 1;
    while ($row = mysqli_fetch_array($query)) {
        ...
        ?>
											...
											<td >
												...
												<a class="btn btn-success btn-print fa fa-file" href="<?php echo "ver_datos_facturacion.php?id_entrada=$id_entrada"; ?>"  role="button">&nbsp;Boleta</a>
												<?php }?>
												<a class="btn btn-info fa fa-print" href="<?php echo "../estadia/generar_ticket.php?codigo=$codigo&boletas=1"; ?>"  role="button"></a>
												<a class="btn btn-danger fa fa-trash" href="<?php echo "eliminar_ticket.php?id_entrada=$id_entrada"; ?>"  role="button"></a>
											</td>
											</tr>
