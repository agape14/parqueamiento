<?php
$ruc     = "10755005211";
$ruta    = "../api_cpe/PRODUCCION/10755005211/";
...
<html lang="es">
                            ...
                            <div class="col-md-12 form">
                                <form action="#" class="form-horizontal" id="login-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5">
                                            <button type="button" onclick="nuevaBusquedaComprobante()" class="btn btn-success">Nueva busqueda</button>
                                        </div>
                                    </div>
                                    <div id="xmlComprobantes">
                                        --------------------------------------------------------------------------------------- <br>
                                        Existe el documento <?php echo $archivo; ?> <br>
                                        ---------------------------------------------------------------------------------------
                                        <p>Utilice los siguientes botones para descargar los archivos deseados</p>
                                        <fieldset>
    ...
    <script type='text/javascript'>
                                                function nuevaBusquedaComprobante() {
                                                    document.location.href = "/pag_cliente/verComprobante.php";
                                                }
                                                function BuscarComprobante() {
                                                    var fichero = "<?php echo $ruc; ?>" + "-" + $('#txtTipoDte').val() + "-" + $('#txtNroComprobante').val();
                                                    document.location.href = "/pag_cliente/verComprobante.php?archivo=" + fichero;
                                                }
